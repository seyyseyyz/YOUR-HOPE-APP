...
const QUOTES = {
  ...
  kh: [
    ...
    "ធ្វើការលើសុបិន្តរបស់អ្នកក្នុងពេលវេលាដែលងាយស្រួលនឹងមិនដំណើរការទេ។ ពេលដែលអ្នកក្លាហាននឹងសុបិន្ត អ្នកក៏ត្រូវក្លាហាននឹងការធ្វើ។",
    "ធ្វើឱ្យបង្វែលក្រុមទីពីររបស់អ្នក វាដឹងផ្លូវ។",
    "ខ្ញុំឈប់ស្វាងជីវិតរបស់ខ្ញុំប្រឆាំងនឹងមនុស្សដែលបានទទួលផ្តើមដោយស្វាភាវិក។",
    "ការថប់បារម្ភសង្គមបង្កើតចេញពីការស្ថិតក្នុងរង្វង់មនុស្សដែលប្រឆាំងនឹងអ្នក។",
    "ប្រសិនបើអ្នកមានគំនិតល្អ វានឹងភ្លឺលាស់ដូចកាំរស្មីព្រះអាទិត្យ ហើយអ្នកនឹងតែងតែមើលទៅស្អាត។",
    "សុបិន្តក្លាយជាការស្ដាយក្រោយ នៅពេលដែលវាស្ថិតក្នុងចិត្ត មិនត្រូវបានដាំក្នុងដីនៃសកម្មភាពទេ។",
    "ពិភពលោកក្នុងទូរស័ព្ទរបស់អ្នកគឺធំទូលាយ ប៉ុន្តែពិភពលោកខាងក្រៅវាគ្មានដែនកំណត់។",
    "បន្ទាប់ពីអាហារល្ងាចល្អ អ្នកអាចអត់ទោសឱ្យអ្នកណាក៏បាន សូម្បីតែក្រុមគ្រួសាររបស់ខ្លួន។",
    "យើងមិនអាចជ្រើសរើសក្រុមគ្រួសារ ប៉ុន្តែយើងអាចជ្រើសរើសមិត្ត។ ដោយក្លាហាន យើងអាចលុបបំបាត់មនុស្សឆ្កួត ហើយផ្តោតលើអ្នកដែលគោរព ស្រឡាញ់ និងប接待យើង។",
    "គ្រួសារគួរតែជាដ្ឋានសុវត្ថិភាព ប៉ុន្តែជាច្រើនដង វាជាកន្លែងដែលយើងរកឃើញការឈឺចាប់ជ្រៅជ្រះ។",
    ...
    "ភាពខ្វះខាត និងចំណុចខ្សោយរបស់អ្នកគឺជាផ្នែកល្អបំផុត សូមមានមោទនភាពចំពោះវា។",
    ...
    "ពេលខ្លះវាត្រូវការការបែកបាក់ខ្លាំងដើម្បីទទួលបានការបំផ្លិចបំផ្លាញដ៏អស្ចារ្យ។",
    "ធ្វើអ្វីដែលល្អបំផុតសម្រាប់ចិត្ត ទោះបីនោះមានន័យថាចាកចេញ។",
    "អ្នកត្រូវការ អ្នកសមនឹងបានល្អបំផុត អ្នកនៅទីនេះដោយហេតុផល។",
    "អ្វីៗកើតឡើងដោយហេតុផល។ ជីវិតទម្លាក់អ្នកចុះ ដើម្បីឱ្យអ្នកក្រោកឡើងសម្រាប់រឿងល្អជាង។ រស់នៅ អត់ទោស ភ្លេច ហើយដោះលែងអតីតកាល។"
  ]
};
...
const T = {
  eng: {
    ...
    aEye:'About Us', aTitle:'Your HOPE', aSub:'Dedicated to making mental health support accessible to everyone in Phnom Penh',
    aMissionTitle:'Our Mission', aMissionText:'To empower individuals in Phnom Penh with accessible mental health screening and support.',
    aVisionTitle:'Our Vision', aVisionText:'A Phnom Penh where mental health is understood, normalized, and supported.',
    aValuesTitle:'Our Values',
  ...
  kh: {
    ...
    aEye:'អំពីយើង', aTitle:'ក្តីសង្ឃឹមរបស់អ្នក', aSub:'ឧទ្ទិសដល់ការធ្វើឱ្យការគាំទ្រសុខភាពផ្លូវចិត្តអាចចូលប្រើបានសម្រាប់មនុស្សគ្រប់រូបនៅភ្នំពេញ',
    aMissionTitle:'បេសកកម្មរបស់យើង', aMissionText:'ដើម្បីផ្តល់អំណាចដល់បុគ្គលនៅភ្នំពេញជាមួយនឹងការស្ទង់មតិ និងការគាំទ្រសុខភាពផ្លូវចិត្តដែលអាចចូលប្រើបាន។',
    aVisionTitle:'ចក្ខុវិស័យរបស់យើង', aVisionText:'ភ្នំពេញដែលសុខភាពផ្លូវចិត្តត្រូវបានយល់ធម្មតា និងគាំទ្រ។',
    aValuesTitle:'តម្លៃរបស់យើង',
