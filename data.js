...
const QUOTES = {
  eng: {
    hope: [
      ...
      "Everything happens for a reason. Life puts you down, only so you can get back up for the better things."
    ],
    strength: [
  ...
  kh: {
    ...
    strength: [
      "មនុស្សខ្លាំងបំផុតគឺមនុស្សដែលបានប្រឈមមុខនឹងការបរាជ័យ ហើយសម្រេចចិត្តប្រយុទ្ធត្រឡប់មកវិញ។",
      "ថ្ងៃនឹងមកដែលអ្នកមិនចង់ប្រយុទ្ធ ប៉ុន្តែត្រូវតែពាក់ស្រោមដៃ។",
      "អ្នកបង្ខំខ្លួនឯងទៅមុខ ថែមទាំងពេលដែលអ្នកអស់កម្លាំង ខ្ញុំឃើញទាហានក្នុងខ្លួនអ្នក។",
      "ចងចាំថា មិនថាសប្ដាហ៍នេះនាំមកអ្វីក្ដី អ្នកអាចទ្រាំបាន។",
      "មិនថាអ្វីកើតឡើង អ្នកខ្លាំងគ្រប់គ្រាន់ក្នុងការទ្រាំ។",
      "បន្តទៅមុខ ទោះបីអ្នកមានអារម្មណ៍ដូចជាមិនអាចជំហានទៀតបានក៏ដោយ។",
      "អ្នកបានឆ្លងកាត់ភ្លើង ឥឡូវដល់ពេលឱ្យភ្លើងនោះបំភ្លឺផ្លូវទៅមុខ។"
    ],
    selfCare: [
      "ស្គាល់ថាអ្វីធ្វើឱ្យអ្នកសប្បាយ ហើយធ្វើវាឱ្យបានច្រើន។",
      "ដោះលែងអ្វីដែលលែងបម្រើអ្នក។",
      "ធ្វើអ្វីដែលល្អបំផុតសម្រាប់ចិត្ត ទោះបីនោះមានន័យថាចាកចេញ។",
      "ឈប់គិតច្រើន ហើយមើលថាតើអារម្មណ៍ល្អនឹងហូរភ្លាមៗ។",
      "ពេលខ្លះអ្នកត្រូវដកខ្លួនចេញ ដើម្បីឃើញអ្វីៗឱ្យច្បាស់។"
    ],
    mindfulness: [
    ...
    gratitude: [
      "សូមដឹងគុណចំពោះឱកាសគ្រប់យ៉ាងដែលជីវិតផ្ដល់ឱ្យអ្នក។",
      "ប្រកាសភាពខ្លាំងរបស់អ្នក អ្នកបានប្រឹងប្រែងយ៉ាងខ្លាំងដើម្បីសម្រេចបាន។",
      "ប្រសិនបើអ្នកតែងតែប្រាថ្នាចង់បានថ្ងៃស្អែកល្អជាង ប្រហែលជាដល់ពេលរីករាយជាមួយថ្ងៃនេះ។",
      "អ្នកត្រូវការ អ្នកសមនឹងបានល្អបំផុត អ្នកនៅទីនេះដោយហេតុផល។",
      "សូម្បីថ្ងៃអាក្រក់បំផុតរបស់អ្នកក៏មានតែម្ភៃបួនម៉ោងដែរ។ ព្រះអាទិត្យនឹងលិច ហើយថ្ងៃថ្មីនឹងចាប់ផ្ដើម។"
    ]
  }
};
...
const T = {
  eng: {
    ...
    aEye:'About Us', aTitle:'YOUR <span>HOPE</span>', aSub:'Your safe space for mental health support in Phnom Penh',
    aboutHeroTitle:'Your safe space for mental health support.',
    aboutHeroLead:'Helping people understand their emotions, find support, and take the first step toward better mental well-being.',
    aboutStartBtn:'📋 Start DASS-21 Test',
    aboutFindBtn:'📍 Find Mental Health Services',
    aMissionTitle:'Our Mission', aMissionText:'To make mental health support simple, private, and accessible for everyone in Phnom Penh.',
    aVisionTitle:'Our Vision', aVisionText:'A community where mental health is understood, accepted, and supported without stigma.',
    aValuesTitle:'Our Promise',
    aboutPromise1:'Private and secure support',
    aboutPromise2:'Trusted mental health screening',
    aboutPromise3:'Easy access to clinics',
    aboutPromise4:'Encouraging and judgment-free guidance',
    aboutWhyTitle:'Why Choose YOUR HOPE?',
    aboutFeature1Title:'Free DASS-21 Screening', aboutFeature1Desc:'Quick and easy assessment of depression, anxiety, and stress.',
    aboutFeature2Title:'Khmer & English Support', aboutFeature2Desc:'Use the app in your preferred language.',
    aboutFeature3Title:'Instant Results', aboutFeature3Desc:'Get your results immediately and understand your emotions better.',
    aboutFeature4Title:'AI Emotional Support', aboutFeature4Desc:'Chat with our AI assistant anytime you need support.',
    aboutFeature5Title:'Phnom Penh Clinic Directory', aboutFeature5Desc:'Find trusted mental health services and locations near you.',
    aboutFeature6Title:'Motivational Quotes', aboutFeature6Desc:'Daily inspiration to keep you positive and strong.',
    aboutClosingQuote:'“You are not alone. Small steps can lead to better mental health.”',
  ...
  kh: {
    ...
    aEye:'អំពីយើង', aTitle:'ក្តីសង្ឃឹមរបស់អ្នក', aSub:'កន្លែងសុវត្ថិភាពសម្រាប់ការគាំទ្រសុខភាពផ្លូវចិត្តនៅភ្នំពេញ',
    aboutHeroTitle:'កន្លែងសុវត្ថិភាពសម្រាប់ការគាំទ្រសុខភាពផ្លូវចិត្ត។',
    aboutHeroLead:'ជួយមនុស្សឱ្យយល់ពីអារម្មណ៍ ស្វែងរកការគាំទ្រ និងចាប់ផ្តើមជំហានដំបូងទៅកាន់សុខុមាលភាពផ្លូវចិត្តល្អប្រសើរ។',
    aboutStartBtn:'📋 ចាប់ផ្តើមតេស្ត DASS-21',
    aboutFindBtn:'📍 ស្វែងរកសេវាសុខភាពផ្លូវចិត្ត',
    aMissionTitle:'បេសកកម្មរបស់យើង', aMissionText:'ធ្វើឱ្យការគាំទ្រសុខភាពផ្លូវចិត្តងាយស្រួល ឯកជន និងអាចចូលប្រើបានសម្រាប់មនុស្សគ្រប់រូបនៅភ្នំពេញ។',
    aVisionTitle:'ចក្ខុវិស័យរបស់យើង', aVisionText:'សហគមន៍មួយដែលសុខភាពផ្លូវចិត្តត្រូវបានយល់ ទទួលយក និងគាំទ្រដោយគ្មានការរើសអើង។',
    aValuesTitle:'ការសន្យារបស់យើង',
    aboutPromise1:'ការគាំទ្រឯកជន និងមានសុវត្ថិភាព',
    aboutPromise2:'ការស្ទង់មតិសុខភាពផ្លូវចិត្តដែលអាចទុកចិត្តបាន',
    aboutPromise3:'ងាយស្រួលស្វែងរកគ្លីនិក',
    aboutPromise4:'ការណែនាំលើកទឹកចិត្ត និងគ្មានការវិនិច្ឆ័យ',
    aboutWhyTitle:'ហេតុអ្វីជ្រើសរើស YOUR HOPE?',
    aboutFeature1Title:'តេស្ត DASS-21 ឥតគិតថ្លៃ', aboutFeature1Desc:'វាយតម្លៃធ្លាក់ទឹកចិត្ត ការថប់បារម្ភ និងភាពតានតឹងបានលឿន និងងាយស្រួល។',
    aboutFeature2Title:'គាំទ្រខ្មែរ និងអង់គ្លេស', aboutFeature2Desc:'ប្រើកម្មវិធីជាភាសាដែលអ្នកចូលចិត្ត។',
    aboutFeature3Title:'លទ្ធផលភ្លាមៗ', aboutFeature3Desc:'ទទួលបានលទ្ធផលភ្លាមៗ និងយល់អារម្មណ៍របស់អ្នកកាន់តែច្បាស់។',
    aboutFeature4Title:'ការគាំទ្រអារម្មណ៍ដោយ AI', aboutFeature4Desc:'ជជែកជាមួយជំនួយការ AI នៅពេលណាដែលអ្នកត្រូវការការគាំទ្រ។',
    aboutFeature5Title:'បញ្ជីគ្លីនិកនៅភ្នំពេញ', aboutFeature5Desc:'ស្វែងរកសេវាសុខភាពផ្លូវចិត្តដែលអាចទុកចិត្តបាននៅជិតអ្នក។',
    aboutFeature6Title:'ពាក្យលើកទឹកចិត្ត', aboutFeature6Desc:'ការបំផុសគំនិតប្រចាំថ្ងៃ ដើម្បីរក្សាអ្នកឱ្យវិជ្ជមាន និងរឹងមាំ។',
    aboutClosingQuote:'“អ្នកមិននៅម្នាក់ឯងទេ។ ជំហានតូចៗអាចនាំទៅកាន់សុខភាពផ្លូវចិត្តល្អប្រសើរ។”',
